				...
				<nav class="navbar navbar-expand gap-3">
					  ...
					  <div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                                ...
                                <img src="{{custom_asset('assets/admin/images/county/02.png')}}" width="22" alt="">
								</a>
							</li>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{custom_asset('assets/admin/images/avatars/avatar-1.png')}}"  class="msg-avatar" alt="user avatar">
												</div>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{custom_asset('assets/admin/images/avatars/avatar-2.png')}}" class="user-img" alt="user avatar">
							<div class="user-info">
